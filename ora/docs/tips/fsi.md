...
One of my absolute favorite perspectives on language learning comes from the US Foreign Service Institute ([FSI](https://en.wikipedia.org/wiki/Foreign_Service_Institute)), in particular: [Theory and Practice in Government Language Teaching](http://lingua.avant.net/wp-content/uploads/2018/01/FSI.pdf). It’s written as an academic paper, but it’s by far the most useful thing I’ve ever read about language learning.
