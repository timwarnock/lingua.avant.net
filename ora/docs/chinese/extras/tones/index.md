...
In my opinion the best approach is to do drills with phrases by native speakers; try to copy the way they speak. Repeat until it becomes muscle memory, that is, until you’ve developed [automaticity](../../../english/extras/advice.md#4-automaticity-and-disruption), and make sure you can be understood by native speakers.
